...
<div class="bg-black text-white relative -mb-8">
    ...
    updateResponsiveImages() {
        ...
        <img class="pointer-events-none size-full object-cover rounded-lg transition-all duration-300 group-hover:scale-110" loading="lazy" src="{{ asset('media.luxteria.co/5328380f48394891596754e3acd5bffe/mixologist.jpg') }}" alt="mixologist.jpg">
    </div>
        </div>
                ...
                <div class="grid lg:grid-cols-3 gap-6">
                        <div
                            class="h-full relative overflow-hidden rounded-2xl min-h-64 z-10">
                                                            <img class="absolute inset-0 -z-10 size-full object-cover" src="{{ asset('media.luxteria.co/5328380f48394891596754e3acd5bffe/mixologist.jpg') }}" alt="mixologist.jpg">
                                                    </div>
    ...
    updateResponsiveImages() {
        ...
        if (this.modalIsOpen) {
            ...
            <div class="mb-4">
            <div class="relative overflow-hidden rounded-lg w-full mb-2 aspect-square aspect-[4/3]" wire:ignore>
        <img class="pointer-events-none size-full object-cover rounded-lg transition-all duration-300 group-hover:scale-110" loading="lazy" src="{{ asset('media.luxteria.co/b774807d82136d0ad4b61f6dcb0b5cf9/flower.jpg') }}" alt="flower.jpg">
    </div>
        </div>
        ...
        <div x-show="modalIsOpen"
            ...
            <div class="px-6 py-4 overflow-y-auto">
                <div class="grid lg:grid-cols-3 gap-6">
                        <div
                            class="h-full relative overflow-hidden rounded-2xl min-h-64 z-10">
                                                            <img class="absolute inset-0 -z-10 size-full object-cover" src="{{ asset('media.luxteria.co/b774807d82136d0ad4b61f6dcb0b5cf9/flower.jpg') }}" alt="flower.jpg">
                                                    </div>
                        <div class="lg:col-span-2">
    ...
    updateResponsiveImages() {
        ...
        if (this.modalIsOpen) {
            ...
            <div class="mb-4">
            <div class="relative overflow-hidden rounded-lg w-full mb-2 aspect-square aspect-[4/3]" wire:ignore>
        <img class="pointer-events-none size-full object-cover rounded-lg transition-all duration-300 group-hover:scale-110" loading="lazy" src="{{ asset('media.luxteria.co/941aa795619a7dfbf3dbb78639971c52/custom-experiences.jpg') }}" alt="custom experiences.jpg">
    </div>
        </div>
        ...
        <div x-show="modalIsOpen"
            ...
            <div class="px-6 py-4 overflow-y-auto">
                <div class="grid lg:grid-cols-3 gap-6">
                        <div
                            class="h-full relative overflow-hidden rounded-2xl min-h-64 z-10">
                                                            <img class="absolute inset-0 -z-10 size-full object-cover" src="{{ asset('media.luxteria.co/941aa795619a7dfbf3dbb78639971c52/custom-experiences.jpg') }}" alt="custom experiences.jpg">
                                                    </div>
                        <div class="lg:col-span-2">
    ...
    updateResponsiveImages() {
        ...
        if (this.modalIsOpen) {
            ...
            <div class="mb-4">
            <div class="relative overflow-hidden rounded-lg w-full mb-2 aspect-square aspect-[4/3]" wire:ignore>
        <img class="pointer-events-none size-full object-cover rounded-lg transition-all duration-300 group-hover:scale-110" loading="lazy" src="{{ asset('media.luxteria.co/b38582d96fce807f81239fb66aaf56cf/security.jpg') }}" alt="security.jpg">
    </div>
        </div>
        ...
        <div x-show="modalIsOpen"
            ...
            <div class="px-6 py-4 overflow-y-auto">
                <div class="grid lg:grid-cols-3 gap-6">
                        <div
                            class="h-full relative overflow-hidden rounded-2xl min-h-64 z-10">
                                                            <img class="absolute inset-0 -z-10 size-full object-cover" src="{{ asset('media.luxteria.co/b38582d96fce807f81239fb66aaf56cf/security.jpg') }}" alt="security.jpg">
                                                    </div>
                        <div class="lg:col-span-2">
    ...
    updateResponsiveImages() {
        ...
        if (this.modalIsOpen) {
            ...
            <div class="mb-4">
            <div class="relative overflow-hidden rounded-lg w-full mb-2 aspect-square aspect-[4/3]" wire:ignore>
        <img class="pointer-events-none size-full object-cover rounded-lg transition-all duration-300 group-hover:scale-110" loading="lazy" src="{{ asset('media.luxteria.co/ab3a50d2165f174e77d1c9a83b91df71/Club-reso.jpg') }}" alt="Club reso.jpg">
    </div>
        </div>
        ...
        <div x-show="modalIsOpen"
            ...
            <div class="px-6 py-4 overflow-y-auto">
                <div class="grid lg:grid-cols-3 gap-6">
                        <div
                            class="h-full relative overflow-hidden rounded-2xl min-h-64 z-10">
                                                            <img class="absolute inset-0 -z-10 size-full object-cover" src="{{ asset('media.luxteria.co/ab3a50d2165f174e77d1c9a83b91df71/Club-reso.jpg') }}" alt="Club reso.jpg">
                                                    </div>
                        <div class="lg:col-span-2">
    ...
    updateResponsiveImages() {
        ...
        if (this.modalIsOpen) {
            ...
            <div class="mb-4">
            <div class="relative overflow-hidden rounded-lg w-full mb-2 aspect-square aspect-[4/3]" wire:ignore>
        <img class="pointer-events-none size-full object-cover rounded-lg transition-all duration-300 group-hover:scale-110" loading="lazy" src="{{ asset('media.luxteria.co/5da61508c16b8e379d882cf41791e739/Caviar.jpg') }}" alt="Caviar.jpg">
    </div>
        </div>
        ...
        <div x-show="modalIsOpen"
            ...
            <div class="px-6 py-4 overflow-y-auto">
                <div class="grid lg:grid-cols-3 gap-6">
                        <div
                            class="h-full relative overflow-hidden rounded-2xl min-h-64 z-10">
                                                            <img class="absolute inset-0 -z-10 size-full object-cover" src="{{ asset('media.luxteria.co/5da61508c16b8e379d882cf41791e739/Caviar.jpg') }}" alt="Caviar.jpg">
                                                    </div>
                        <div class="lg:col-span-2">
    ...
    updateResponsiveImages() {
        ...
        if (this.modalIsOpen) {
            ...
            <div class="mb-4">
            <div class="relative overflow-hidden rounded-lg w-full mb-2 aspect-square aspect-[4/3]" wire:ignore>
        <img class="pointer-events-none size-full object-cover rounded-lg transition-all duration-300 group-hover:scale-110" loading="lazy" src="{{ asset('media.luxteria.co/88df07b16579031cab7cd9edb6462f7c/liquor.jpg') }}" alt="liquor.jpg">
    </div>
        </div>
        ...
        <div x-show="modalIsOpen"
            ...
            <div class="px-6 py-4 overflow-y-auto">
                <div class="grid lg:grid-cols-3 gap-6">
                        <div
                            class="h-full relative overflow-hidden rounded-2xl min-h-64 z-10">
                                                            <img class="absolute inset-0 -z-10 size-full object-cover" src="{{ asset('media.luxteria.co/88df07b16579031cab7cd9edb6462f7c/liquor.jpg') }}" alt="liquor.jpg">
                                                    </div>
                        <div class="lg:col-span-2">
    ...
    updateResponsiveImages() {
        ...
        if (this.modalIsOpen) {
            ...
            <div class="mb-4">
            <div class="relative overflow-hidden rounded-lg w-full mb-2 aspect-square aspect-[4/3]" wire:ignore>
        <img class="pointer-events-none size-full object-cover rounded-lg transition-all duration-300 group-hover:scale-110" loading="lazy" src="{{ asset('media.luxteria.co/a948504ff5d5657adef1c449438e802b/private-jet.jpg') }}" alt="private jet.jpg">
    </div>
        </div>
        ...
        <div x-show="modalIsOpen"
            ...
            <div class="px-6 py-4 overflow-y-auto">
                <div class="grid lg:grid-cols-3 gap-6">
                        <div
                            class="h-full relative overflow-hidden rounded-2xl min-h-64 z-10">
                                                            <img class="absolute inset-0 -z-10 size-full object-cover" src="{{ asset('media.luxteria.co/a948504ff5d5657adef1c449438e802b/private-jet.jpg') }}" alt="private jet.jpg">
                                                    </div>
                        <div class="lg:col-span-2">
    ...
    updateResponsiveImages() {
        ...
        if (this.modalIsOpen) {
            ...
            <div class="mb-4">
            <div class="relative overflow-hidden rounded-lg w-full mb-2 aspect-square aspect-[4/3]" wire:ignore>
        <img class="pointer-events-none size-full object-cover rounded-lg transition-all duration-300 group-hover:scale-110" loading="lazy" src="{{ asset('media.luxteria.co/1abae8695c8fbcdc1735582b53e27108/IV.jpg') }}" alt="IV.jpg">
    </div>
        </div>
        ...
        <div x-show="modalIsOpen"
            ...
            <div class="px-6 py-4 overflow-y-auto">
                <div class="grid lg:grid-cols-3 gap-6">
                        <div
                            class="h-full relative overflow-hidden rounded-2xl min-h-64 z-10">
                                                            <img class="absolute inset-0 -z-10 size-full object-cover" src="{{ asset('media.luxteria.co/1abae8695c8fbcdc1735582b53e27108/IV.jpg') }}" alt="IV.jpg">
                                                    </div>
                        <div class="lg:col-span-2">
    ...
    updateResponsiveImages() {
        ...
        if (this.modalIsOpen) {
            ...
            <div class="mb-4">
            <div class="relative overflow-hidden rounded-lg w-full mb-2 aspect-square aspect-[4/3]" wire:ignore>
        <img class="pointer-events-none size-full object-cover rounded-lg transition-all duration-300 group-hover:scale-110" loading="lazy" src="{{ asset('media.luxteria.co/ecad80e72e8e3ecbb57128a147f1b2c9/sprinter.jpg') }}" alt="sprinter.jpg">
    </div>
        </div>
        ...
        <div x-show="modalIsOpen"
            ...
            <div class="px-6 py-4 overflow-y-auto">
                <div class="grid lg:grid-cols-3 gap-6">
                        <div
                            class="h-full relative overflow-hidden rounded-2xl min-h-64 z-10">
                                                            <img class="absolute inset-0 -z-10 size-full object-cover" src="{{ asset('media.luxteria.co/ecad80e72e8e3ecbb57128a147f1b2c9/sprinter.jpg') }}" alt="sprinter.jpg">
                                                    </div>
                        <div class="lg:col-span-2">
    ...
    updateResponsiveImages() {
        ...
        if (this.modalIsOpen) {
            ...
            <div class="mb-4">
            <div class="relative overflow-hidden rounded-lg w-full mb-2 aspect-square aspect-[4/3]" wire:ignore>
        <img class="pointer-events-none size-full object-cover rounded-lg transition-all duration-300 group-hover:scale-110" loading="lazy" src="{{ asset('media.luxteria.co/e53a3876986e2453f046ffa7afa57230/Restaurant.jpg') }}" alt="Restaurant.jpg">
    </div>
        </div>
        ...
        <div x-show="modalIsOpen"
            ...
            <div class="px-6 py-4 overflow-y-auto">
                <div class="grid lg:grid-cols-3 gap-6">
                        <div
                            class="h-full relative overflow-hidden rounded-2xl min-h-64 z-10">
                                                            <img class="absolute inset-0 -z-10 size-full object-cover" src="{{ asset('media.luxteria.co/e53a3876986e2453f046ffa7afa57230/Restaurant.jpg') }}" alt="Restaurant.jpg">
                                                    </div>
                        <div class="lg:col-span-2">
    ...
    updateResponsiveImages() {
        ...
        if (this.modalIsOpen) {
            ...
            <div class="mb-4">
            <div class="relative overflow-hidden rounded-lg w-full mb-2 aspect-square aspect-[4/3]" wire:ignore>
        <img class="pointer-events-none size-full object-cover rounded-lg transition-all duration-300 group-hover:scale-110" loading="lazy" src="{{ asset('media.luxteria.co/aab384c821c532068a7c78864fe3e763/grocery.jpg') }}" alt="grocery.jpg">
    </div>
        </div>
        ...
        <div x-show="modalIsOpen"
            ...
            <div class="px-6 py-4 overflow-y-auto">
                <div class="grid lg:grid-cols-3 gap-6">
                        <div
                            class="h-full relative overflow-hidden rounded-2xl min-h-64 z-10">
                                                            <img class="absolute inset-0 -z-10 size-full object-cover" src="{{ asset('media.luxteria.co/aab384c821c532068a7c78864fe3e763/grocery.jpg') }}" alt="grocery.jpg">
                                                    </div>
                        <div class="lg:col-span-2">
    ...
    updateResponsiveImages() {
        ...
        if (this.modalIsOpen) {
            ...
            <div class="mb-4">
            <div class="relative overflow-hidden rounded-lg w-full mb-2 aspect-square aspect-[4/3]" wire:ignore>
        <img class="pointer-events-none size-full object-cover rounded-lg transition-all duration-300 group-hover:scale-110" loading="lazy" src="{{ asset('media.luxteria.co/7e3c280d5c15bf5b91c6ede0aa7c7d46/chef.jpg') }}" alt="chef.jpg">
    </div>
        </div>
        ...
        <div x-show="modalIsOpen"
            ...
            <div class="px-6 py-4 overflow-y-auto">
                <div class="grid lg:grid-cols-3 gap-6">
                        <div
                            class="h-full relative overflow-hidden rounded-2xl min-h-64 z-10">
                                                            <img class="absolute inset-0 -z-10 size-full object-cover" src="{{ asset('media.luxteria.co/7e3c280d5c15bf5b91c6ede0aa7c7d46/chef.jpg') }}" alt="chef.jpg">
                                                    </div>
                        <div class="lg:col-span-2">
    ...
    updateResponsiveImages() {
        ...
        if (this.modalIsOpen) {
            ...
            <div class="mb-4">
            <div class="relative overflow-hidden rounded-lg w-full mb-2 aspect-square aspect-[4/3]" wire:ignore>
        <img class="pointer-events-none size-full object-cover rounded-lg transition-all duration-300 group-hover:scale-110" loading="lazy" src="{{ asset('media.luxteria.co/a2e1b25de28957b364af71b3d74563b3/test.jpg') }}" alt="test.jpg">
    </div>
        </div>
        ...
        <div x-show="modalIsOpen"
            ...
            <div class="px-6 py-4 overflow-y-auto">
                <div class="grid lg:grid-cols-3 gap-6">
                        <div
                            class="h-full relative overflow-hidden rounded-2xl min-h-64 z-10">
                                                            <img class="absolute inset-0 -z-10 size-full object-cover" src="{{ asset('media.luxteria.co/a2e1b25de28957b364af71b3d74563b3/test.jpg') }}" alt="test.jpg">
                                                    </div>
                        <div class="lg:col-span-2">
    ...
    updateResponsiveImages() {
        ...
        if (this.modalIsOpen) {
            ...
            <div class="mb-4">
            <div class="relative overflow-hidden rounded-lg w-full mb-2 aspect-square aspect-[4/3]" wire:ignore>
        <img class="pointer-events-none size-full object-cover rounded-lg transition-all duration-300 group-hover:scale-110" loading="lazy" src="{{ asset('media.luxteria.co/f396f2511b9c29c00f79eb434a9baef1/massage.jpg') }}" alt="massage.jpg">
    </div>
        </div>
        ...
        <div x-show="modalIsOpen"
            ...
            <div class="px-6 py-4 overflow-y-auto">
                <div class="grid lg:grid-cols-3 gap-6">
                        <div
                            class="h-full relative overflow-hidden rounded-2xl min-h-64 z-10">
                                                            <img class="absolute inset-0 -z-10 size-full object-cover" src="{{ asset('media.luxteria.co/f396f2511b9c29c00f79eb434a9baef1/massage.jpg') }}" alt="massage.jpg">
                                                    </div>
                        <div class="lg:col-span-2">
